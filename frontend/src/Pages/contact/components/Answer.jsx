    ...
    <div className="max-w-6xl mx-auto py-16 px-4 sm:px-6 lg:px-8 bg-white">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        ...
        <div className="relative h-full min-h-[400px] lg:min-h-[600px] flex items-center justify-center rounded-xl overflow-hidden shadow-lg">
          ...
          />
          {/* Green overlay shapes (Blobs) */}
          <div className="absolute top-1/4 left-1/4 w-48 h-48 bg-lime-200 opacity-60 rounded-full mix-blend-multiply filter blur-xl"></div>
          <div className="absolute bottom-1/4 right-1/4 w-60 h-60 bg-lime-300 opacity-60 rounded-full mix-blend-multiply filter blur-xl"></div>
          <div className="absolute top-1/3 right-1/3 w-32 h-32 bg-lime-100 opacity-60 rounded-full mix-blend-multiply filter blur-xl"></div>
        </div>
      </div>
    </div>
  );
